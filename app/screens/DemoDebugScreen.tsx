...
export const DemoDebugScreen: FC<DemoTabScreenProps<"DemoDebug">> = function DemoDebugScreen(
  ...
  return (
    ...
    >
      <Text style={themed($title)} preset="heading" text="Dev Mode" />
      <Text preset="bold">Current system theme: {colorScheme}</Text>
      <Text preset="bold">Current app theme: {themeContext}</Text>
      <Button onPress={resetTheme} text={`Reset`} preset="default" />

      <View style={themed($itemsContainer)}>
        <Button onPress={toggleTheme} preset="reversed" text={`Toggle Theme: ${themeContext}`} />
      </View>
      <View style={themed($itemsContainer)}>
        <ListItem
          LeftComponent={
      ...
      <View style={themed($buttonContainer)}>
        <Button style={themed($button)} text="Reactotron" onPress={demoReactotron} />
      </View>
      <View style={themed($buttonContainer)}>
        <Button style={themed($button)} text="Logout" onPress={logout} />
      </View>
    </Screen>
  )
}
